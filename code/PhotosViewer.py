...
class PhotoWindow(QWidget):
    def __init__(self, drawSelf):
        ...
        self.saveas = file_menu.addAction(self.tr('Guardar como'))
        self.saveas.triggered.connect(self.saveas_call)

        filters_menu = menu_bar.addMenu(self.tr('Filtros'))

        self.gray_filter_status = False
        self.gray_filter_btn = filters_menu.addAction(self.tr('Filtro en escala de grises'))
        ...
        self.mirror_filter_btn = filters_menu.addAction(self.tr('Filtro de espejo'))
        ...
        self.mono_filter_btn = filters_menu.addAction(self.tr('Filtro mono'))
...
#        self.infoPhoto3.setAlignment(Qt.AlignCenter)
        ...
        # Add tips on buttons
        self.extent.setToolTip(self.tr('Extención total de la foto'))
        self.zoom.setToolTip(self.tr('Selecciona area de zoom'))
        self.pan.setToolTip(self.tr('Paneo'))
        self.zoom_to_select.setToolTip(self.tr('Zoom a punto de foto seleccionada'))
        self.rotate_option.setToolTip(self.tr('Rotar 45°'))
        self.rotate_azimuth.setToolTip(self.tr('Rotar al azimuth'))
        self.hide_arrow.setToolTip(self.tr('Ocultar flechas'))
